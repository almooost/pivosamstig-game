        ...
        <div className="TaskWrapper">
            <div className="Task">
                ...
                <p className="description">
                    ...
                    <i><a href="https://goo.gl/maps/mJ4wgrSkc1VPmRse7" target="_blank">Wo</a> könnte es den ganz viele verschiedene <a href="https://goo.gl/maps/mJ4wgrSkc1VPmRse7" target="_blank">Biere</a> in eurer <a href="https://goo.gl/maps/mJ4wgrSkc1VPmRse7" target="_blank">Nähe</a> geben, ich frage mich <a href="https://goo.gl/maps/mJ4wgrSkc1VPmRse7" target="_blank">Wo genau?</a></i>
                    <br /><br />
                    <h3>
